...
NOTE: Moving to https://github.com/Gordon999/RPiCamGUI with renaming to rpicam
...
I have only tested switching 2 cameras on a Pi5, right click on preview image, with official Pi Cameras. It will work with different models of camera
