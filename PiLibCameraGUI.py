...
vwidths      = [640,800,1280,1280,1920]
vheights     = [480,600, 720, 960,1080]
v_max_fps    = [90 , 40,  40,  40,  30]
...
def preview():
    ...
    if speed2 > 6000000:
        speed2 = 6000000
    rpistr = "libcamera-vid -n --codec mjpeg -t 0 --segment 200 --width " + str(preview_width) + " --height " + str(preview_height) + " -o /run/shm/test%d.jpg "
