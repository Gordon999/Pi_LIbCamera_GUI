...
def preview():
    ...
    if speed2 > 6000000:
        speed2 = 6000000
    rpistr = "libcamera-still -e jpg -n -t 0 --width " + str(preview_width) + " --height " + str(preview_height) + " -o /run/shm/test%d.jpg --framestart 10  --timelapse 100 "
...
rpistr = "libcamera-jpeg -n -t 1000 -e bmp -o test.jpg"
os.system(rpistr)
time.sleep(2)
if os.path.exists('test.jpg'):
   imagefile = 'test.jpg'
...
while True:
    time.sleep(0.1)
    #print ('/run/shm/test' + str(count - 1) + '.jpg')
    pics = glob.glob('/run/shm/*.jpg')
    if os.path.exists('/run/shm/test' + str(count - 1) + '.jpg') and len(pics) > 2:
        try:
            image = pygame.image.load('/run/shm/test' + str(count - 1) + '.jpg')
        except pygame.error:
            pass
        os.rename('/run/shm/test' + str(count - 1 ) + '.jpg', '/run/shm/oldtest.jpg')
        count +=1
