...
vwidths      = [640,800,1280,1280,1920,2592]
vheights     = [480,600, 720, 960,1080,1944]
v_max_fps    = [90 , 40,  40,  40,  30,  20]
...
video_limits = ['vlen',1,999,'fps',1,40,'vformat',0,len(vwidths)-1,'0',0,0,'sharpness',0,4,'denoise',0,len(denoises)-1,'zoom',0,4,'Focus',0,1,'tduration',1,9999,'tinterval',0,999,'tshots',1,999,'flicker',0,3,'codec',0,len(codecs)-1]
...
def preview():
    ...
    if speed2 > 6000000:
        speed2 = 6000000
    rpistr = "libcamera-vid -n --codec mjpeg -t 0 --segment 100 --width " + str(preview_width) + " --height " + str(preview_height) + " -o /run/shm/test%d.jpg "
